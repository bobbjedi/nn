...
DQNAgent.prototype = {
  ...
  reset: function () {
    ...
    this.net = {}
    // hidden layer
    this.net.W1 = new RandMat(this.nh, this.ns, 0, 0.01) // input = States count, output = Hidden Neurons count
    this.net.b1 = new Mat(this.nh, 1, 0, 0.01) // biases count = Hidden Neurons count
    // output later
    this.net.W2 = new RandMat(this.na, this.nh, 0, 0.01) // input = Hidden Neurons count, output = Actions count
